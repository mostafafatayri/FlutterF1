...
class RaceWeekendPage extends StatefulWidget {
  ...
  @override
  _RaceWeekendPageState createState() => _RaceWeekendPageState(raceId: raceId);
}
...
class _RaceWeekendPageState extends State<RaceWeekendPage> {
 ...
 // String raceId = 'your_race_id_here'; // You need to set this to the actual race ID you're working with
  ...
  _RaceWeekendPageState({Key? key, required this.raceId}) ;//: super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    if (!snapshot.hasData) {
    return Center(child: Text("Race not found"));
    }



    // Assuming your calendar data has fields for 'ImageURL' and 'RaceName'
    var data = snapshot.data!.data() as Map<String, dynamic>;
    String imageUrl = 'https://media.formula1.com/image/upload/f_auto/q_auto/v1677245019/content/dam/fom-website/2018-redesign-assets/Racehub%20header%20images%2016x9/Japan.jpg.transform/12col-retina/image.jpg';//data['ImageURL'] ?? 'default_image_url';
    String raceName = data['Title'] ?? 'Race Name';
    final trackId = data['Track'];
    //
    ...
    String imageUrl = trackData['CircuitImage']; // Assuming 'CircuitImage' is the field name in your 'Tracks' collection
